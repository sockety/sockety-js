...
// TODO: Use dynamic declarations inside of regular declarations
export const arrayDeclaration = createDeclaration({
  read: (length: number, reader: BufferReader<any>) => (operation, prefix) => operation
    .initialValue('[]')
    .resetValue(true)
...
export const arrayContinuousDeclaration = createDeclaration({
  read: (length: number, reader: BufferReader<any>) => (operation, prefix) => operation
    .initialValue('[]')
    .resetValue(true)
